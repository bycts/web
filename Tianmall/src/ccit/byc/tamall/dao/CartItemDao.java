...
public class CartItemDao {
	...
	public List<CartItem> findByUser(String uid) throws SQLException {
		String sql = "select * from t_cartitem c, t_product b where c.bid=b.bid and uid=? order by c.orderBy";
	...
	public CartItem findByUidAndBid(String uid, String bid) throws SQLException {
		...
		public void addCartItem(CartItem cartItem) throws SQLException {
			...
			Object[] params = {cartItem.getCartItemId(), cartItem.getQuantity(),
					cartItem.getProduct().getBid(), cartItem.getUser().getUid()};
		 ...
		 */
			...
			public CartItem findByCartItemId(String cartItemId) throws SQLException {
				String sql = "select * from t_cartItem c, t_product b where c.bid=b.bid and c.cartItemId=?";
			...
			public List<CartItem> loadCartItems(String cartItemIds) throws SQLException {
				 ...
				 * 3. 生成sql语句
				 */
				String sql = "select * from t_cartitem c, t_product b where c.bid=b.bid and " + whereSql;
				/*
